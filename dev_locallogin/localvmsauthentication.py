...
def index():
    ...
    if code:
        ...
        return render_template_string(LOGIN_TEMPLATE, userId=userId, access_token=access_token, refresh_token=refresh_token, oauthObject=oauthObject)
    else:
    ...
    <div class="container mt-5">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="accessToken" value="{{ access_token }}" readonly>
                <div class="input-group-append">
                    <button class="btn btn-primary" onclick="copyToClipboard('accessToken')">COPY</button>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <button class="btn btn-primary" onclick="copyToClipboard('refreshToken')">COPY</button>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-group">
                <textarea class="form-control" id="jsonResponse" readonly style="height: 18em; white-space: pre-wrap;">{{ oauthObject | tojson }}</textarea>
                <div class="input-group-append">
                    <button class="btn btn-primary" onclick="copyToClipboard('jsonResponse')">COPY</button>
                </div>
            </div>
        </div>
